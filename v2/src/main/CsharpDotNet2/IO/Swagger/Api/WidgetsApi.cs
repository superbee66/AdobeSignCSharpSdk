...
namespace AdobeSignClient.V2.Api
{
    ...
    public interface IWidgetsApi
    {
        ...
        ///     &lt;/li&gt;&lt;/ul&gt;(Legacy clients can use the access token obtained from /auth/tokens endpoint.)
        /// </param>
        ...
        ///     The email address of the user on whose behalf widget is being created. If both X-User-Id and
        ...
        /// <param name="xUserEmail">
        ///     The email address of the user whose widgets are being requested. If both X-User-Id and
        ///     X-User-Email are provided then X-User-Id is given preference. If neither is specified then the user is inferred
        ///     from the access token.
        /// </param>
