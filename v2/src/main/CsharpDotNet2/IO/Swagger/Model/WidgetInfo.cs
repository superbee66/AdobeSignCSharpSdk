...
namespace AdobeSignClient.V2.Model
{
    ...
    public class WidgetInfo
    {
        ...
        /// <summary>
        ///     Information about all the participants of this widget
        /// </summary>
        /// <value>Information about all the participants of this widget</value>
        [DataMember(Name = "participants", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "participants")]
        public List<WidgetParticipantInfo> Participants { get; set; }

        /// <summary>
        ///     Security information about the widget that specifies whether or not a password is required to view and sign the
        ///     widget
        /// </summary>
        /// <value>
        ///     Security information about the widget that specifies whether or not a password is required to view and sign the
