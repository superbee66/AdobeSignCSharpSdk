...
namespace AdobeSignClient.V2.Model
{
    ...
    public class InteractiveOptions
    {
        ...
        /// <summary>
        ///     The locale in which page returned by this API should be shown in - for example, en_US or fr_FR. In case locale
        ///     provided by client is not available or no locale is specified, page will be shown in the default language set in
        ///     the user account
        /// </summary>
        /// <value>
        ///     The locale in which page returned by this API should be shown in - for example, en_US or fr_FR. In case locale
        ...
        /// <summary>
        ///     A url to send page will be returned from where the agreement creation needs to be completed. All the parameters
        ///     provided here will be retained in the send page
        /// </summary>
        /// <value>
        ///     A url to send page will be returned from where the agreement creation needs to be completed. All the parameters
        ///     provided here will be retained in the send page
        ...
        /// <summary>
        ///     A JSON object of Type SendThroughWebOptions to customize the sendPage. This one will apply only if sendThroughWeb
        ///     is set to true
        /// </summary>
        /// <value>
        ///     A JSON object of Type SendThroughWebOptions to customize the sendPage. This one will apply only if
        ///     sendThroughWeb is set to true
        /// </value>
