...
namespace AdobeSignClient.V3.Model
{
    ...
    public class FileInfosDescription
    {
        ...
        /// <summary>
        ///     A list of workflow library documents out of which one workflow library document can be selected with this fileInfo
        ///     object
        /// </summary>
        /// <value>
        ///     A list of workflow library documents out of which one workflow library document can be selected with this
        ///     fileInfo object
        /// </value>
