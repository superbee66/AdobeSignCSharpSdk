...
namespace AdobeSignClient.V3.Model
{
    ...
    {
        /// <summary>
        ///     The secondary password that will be used to protect signing the widget for external signers. Note that Adobe Sign
        ...
        /// </summary>
        /// <value>
        ///     The secondary password that will be used to protect signing the widget for external signers. Note that Adobe
        ...
        /// <summary>
        ///     The secondary password that will be used to protect signing the widget for internal signers. Note that Adobe Sign
        ///     will never show this password to anyone, so you will need to separately communicate it to any relevant parties.
        ///     This password is applied only if password protection is specified for internal signers or all signers
        /// </summary>
        /// <value>
        ///     The secondary password that will be used to protect signing the widget for internal signers. Note that Adobe
        ///     Sign will never show this password to anyone, so you will need to separately communicate it to any relevant
