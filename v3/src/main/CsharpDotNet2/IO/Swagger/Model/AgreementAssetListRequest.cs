...
namespace AdobeSignClient.V3.Model {
  ...
  public class AgreementAssetListRequest {
    ...
    /// </summary>
    /// <value>The ID of the agreement asset to be shown selected in the manage page. If the agreement asset does not lie in the manage page view then URL of default manage page will be generated</value>
