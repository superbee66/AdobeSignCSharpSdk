...
namespace AdobeSignClient.V3.Model
{
    ...
    public class MergeFieldInfoDescription
    {
        ...
        /// <summary>
        ///     Whether current field should be visible on agreement creation page. If visible attribute for this field is false
        ///     then this field should not be shown on the agreement creation page using this workflow
        /// </summary>
        /// <value>
        ///     Whether current field should be visible on agreement creation page. If visible attribute for this field is false
        ///     then this field should not be shown on the agreement creation page using this workflow
