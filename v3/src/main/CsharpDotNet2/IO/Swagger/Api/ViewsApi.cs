...
namespace AdobeSignClient.V3.Api
{
    ...
    public interface IViewsApi
    {
        ...
        /// <param name="xUserEmail">The email address of the user for whom URL is being generated. If both X-User-Id and X-User-Email are provided then X-User-Id is given preference. If neither is specified then the user is inferred from the access token.</param>
