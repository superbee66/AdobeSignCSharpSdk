...
namespace AdobeSignClient.V3.Api
{
    ...
    public interface IUsersApi
    {
        ...
        /// <summary>
        ///     Retrieve detailed information about the user that the caller has permissions to access. Account admins can retrieve
        ///     user info for all the users in their account, group admins can retrieve user info for all users in their group. If
        ///     caller is neither an account admin nor group admin then their own information is returned.
        /// </summary>
        /// <param name="accessToken">
        ///     An &lt;a href&#x3D;\&quot;#\&quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot;
        ///     oncontextmenu&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;OAuth Access Token
