...
namespace AdobeSignClient.V4.Model
{
    ...
    public class TargetViewRequest
    {
        ...
        /// <summary>
        ///     Two types of views are available- ACCOUNT_SETTINGS:- For getting the URL for Account Settings for Admin only,
        ///     USER_PROFILE:- For getting the URL for User Profile
        /// </summary>
        /// <value>
        ///     Two types of views are available- ACCOUNT_SETTINGS:- For getting the URL for Account Settings for Admin only,
        ///     USER_PROFILE:- For getting the URL for User Profile
