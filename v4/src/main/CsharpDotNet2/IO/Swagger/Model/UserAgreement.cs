...
namespace AdobeSignClient.V4.Model
{
    ...
    public class UserAgreement
    {
        ...
        /// </value>
        [DataMember(Name = "displayUserSetInfos", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "displayUserSetInfos")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DisplayUserSetInfos: ").Append(DisplayUserSetInfos).Append("\n");
