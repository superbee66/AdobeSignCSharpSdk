...
namespace AdobeSignClient.V4.Model
{
    ...
    public class RecipientsListInfoDescription
    {
        ...
        /// <summary>
        ///     Whether current field is visible. If visible attribute for this field is false then this field should not be shown
        ///     in the agreement creation UI using this workflow to user
        /// </summary>
        /// <value>
        ///     Whether current field is visible. If visible attribute for this field is false then this field should not be
        ///     shown in the agreement creation UI using this workflow to user
        /// </value>
