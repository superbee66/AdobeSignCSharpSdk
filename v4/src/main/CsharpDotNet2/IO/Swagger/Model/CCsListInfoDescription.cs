...
namespace IO.Swagger.Model {
  ...
  public class CCsListInfoDescription {
    ...
    /// </summary>
    /// <value>Whether current field is visible or not. If visible attribute for this field is false then this field should not be shown in the agreement creation page using this workflow</value>
