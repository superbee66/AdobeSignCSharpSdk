...
namespace AdobeSignClient.V4.Model {
  ...
  public class MegaSignCreationInfo {
    ...
    /// </summary>
    /// <value>A list of one or more recipient sets. Currently a recipient set can have only one recipient.</value>
    [DataMember(Name="recipientSetInfos", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "recipientSetInfos")]
    ...
    /// </summary>
    /// <value>The merge file ID as returned from the transient document creation API. The merge file contains the details of all the Mega Sign recipients.</value>
    [DataMember(Name="mergeFileTransientId", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "mergeFileTransientId")]
    public string MergeFileTransientId { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  RecipientSetInfos: ").Append(RecipientSetInfos).Append("\n");
      sb.Append("  CallbackInfo: ").Append(CallbackInfo).Append("\n");
      sb.Append("  SignatureType: ").Append(SignatureType).Append("\n");
      sb.Append("  ExternalId: ").Append(ExternalId).Append("\n");
      sb.Append("  MergeFileTransientId: ").Append(MergeFileTransientId).Append("\n");
