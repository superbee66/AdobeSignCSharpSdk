...
namespace AdobeSignClient.V6.Model
{
    ...
    /// </summary>
    [DataContract]
    public class WidgetCreationInfoV6
    {
        /// <summary>
        ...
        /// <summary>
        ///     URL and associated properties for the success page the widget signer will be taken to after performing desired
        ...
        /// <summary>
        ///     Date when widget was created. If provided in POST, it will simply be ignored. Format would be
        ...
        /// <summary>
        ///     Email of widget creator. Only returned in GET response. Cannot be provided in POST/PUT request. If provided in
        ///     POST, it will simply be ignored
        /// </summary>
        /// <value>
        ///     Email of widget creator. Only returned in GET response. Cannot be provided in POST/PUT request. If provided in
        ///     POST, it will simply be ignored
        ...
        /// <summary>
        ///     A resource identifier that can be used to uniquely identify the widget in other apis. If provided in POST, it will
        ///     simply be ignored
        /// </summary>
        /// <value>
        ///     A resource identifier that can be used to uniquely identify the widget in other apis. If provided in POST, it
        ...
        /// <summary>
        ///     The state in which the widget should land. For example in order to create a widget in DRAFT state, field should be
        ///     DRAFT. The state field will never get returned in GET /widgets/{ID} and will be ignored if provided in PUT
        ///     /widgets/{ID} call. The eventual status of the widget can be obtained from GET /widgets/ID
        /// </summary>
        /// <value>
        ///     The state in which the widget should land. For example in order to create a widget in DRAFT state, field should
        ///     be DRAFT. The state field will never get returned in GET /widgets/{ID} and will be ignored if provided in PUT
        ///     /widgets/{ID} call. The eventual status of the widget can be obtained from GET /widgets/ID
        /// </value>
