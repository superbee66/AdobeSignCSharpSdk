...
namespace AdobeSignClient.V6.Model
{
    ...
    public class WebhookInfo
    {
        ...
        /// </summary>
        /// <value>Timestamp when the webhook was created. Will only be returned in GET request. Can't be modified in PUT request</value>
        ...
        /// </summary>
        /// <value>
        ///     Timestamp when the webhook was last updated. Will only be returned in GET request. Can't be modified in PUT
        ///     request
        /// </value>
        ...
        /// <summary>
        ///     Id of the resource type for which you want to create webhook. Provide agreementId if webhook needs to be created
        ///     for an agreement. Similarly, widgetId if webhook needs to be created for a widget, megaSignId if webhook needs to
        ///     be created for a megaSign and libraryDocumentId if webhook needs to be created for a library document. Need to
        ///     specify only if scope is 'RESOURCE'. Can't be modified in PUT request
        /// </summary>
        /// <value>
        ///     Id of the resource type for which you want to create webhook. Provide agreementId if webhook needs to be created
        ///     for an agreement. Similarly, widgetId if webhook needs to be created for a widget, megaSignId if webhook needs to
        ...
        /// <summary>
        ///     The resource for which you want to create webhook. Need to specify only if scope is 'RESOURCE'. Can't be modified
        ///     in PUT request. The possible values are AGREEMENT, WIDGET,  MEGASIGN AND LIBRARY_DOCUMENT
        /// </summary>
        /// <value>
        ///     The resource for which you want to create webhook. Need to specify only if scope is 'RESOURCE'. Can't be
        ///     modified in PUT request. The possible values are AGREEMENT, WIDGET,  MEGASIGN AND LIBRARY_DOCUMENT
        /// </value>
        ...
        /// </summary>
        /// <value>The state in which the webhook should be created</value>
        [DataMember(Name = "state", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "state")]
        public string State { get; set; }

        /// <summary>
        ///     Status of the webhook. Determines whether the webhook will be actually triggered. Default: ACTIVE, if ACTIVE, this
        ///     webhook will receive event requests. If INACTIVE, this webhook will not receive event requests. Can't provide
        ///     status in POST/PUT requests.
        /// </summary>
        /// <value>
        ///     Status of the webhook. Determines whether the webhook will be actually triggered. Default: ACTIVE, if ACTIVE,
        ///     this webhook will receive event requests. If INACTIVE, this webhook will not receive event requests. Can't provide
        ///     status in POST/PUT requests.
        /// </value>
        ...
        /// </summary>
        /// <value>Conditions which webhook creator can specify for the payload while creating or updating a webhook</value>
        [DataMember(Name = "webhookConditionalParams", EmitDefaultValue = false)]
        [JsonProperty(PropertyName = "webhookConditionalParams")]
        public WebhookConditionalParams WebhookConditionalParams { get; set; }

        /// <summary>
        ///     Determines events for which the webhook is triggered. The possible values are
        ///     <br>
        ...
        ///                                                 <br>
        ///                                                     , AGREEMENT_ACTION_REQUESTED : When an agreement action is
        ///                                                     requested
        ///                                                     <br>
        ///                                                         , AGREEMENT_ACTION_REPLACED_SIGNER : When signer is replaced
        ///                                                         for an agreement
        ///                                                         <br>
        ///                                                             , AGREEMENT_AUTO_CANCELLED_CONVERSION_PROBLEM : When an
        ///                                                             agreement is auto-cancelled due to conversion problem
        ///                                                             <br>
        ///                                                                 , AGREEMENT_DOCUMENTS_DELETED : When an agreement
        ///                                                                 documents are deleted
        ///                                                                 <br>
        ///                                                                     , AGREEMENT_EMAIL_BOUNCED : When an agreement email
        ///                                                                     gets bounced
        ///                                                                     <br>
        ///                                                                         , AGREEMENT_KBA_AUTHENTICATED : When an
        ///                                                                         agreement KBA is authenticated
        ///                                                                         <br>
        ///                                                                             , AGREEMENT_OFFLINE_SYNC : When an
        ///                                                                             agreement is synced offline
        ///                                                                             <br>
        ///                                                                                 , AGREEMENT_USER_ACK_AGREEMENT_MODIFIED
        ///                                                                                 : User Acknowledgement when an
        ///                                                                                 agreement is modified
        ///                                                                                 <br>
        ///                                                                                     , AGREEMENT_UPLOADED_BY_SENDER :
        ///                                                                                     When an agreement is uploaded by
        ///                                                                                     sender
        ///                                                                                     <br>
        ///                                                                                         ,
        ///                                                                                         AGREEMENT_WEB_IDENTITY_AUTHENTICATED
        ///                                                                                         : When an agreement web
        ///                                                                                         identity is authenticated
        ///                                                                                         <br>
        ///                                                                                             , AGREEMENT_ALL : All the
        ///                                                                                             supported agreement events
        ///                                                                                             for Webhooks
        ///                                                                                             <br>
        ///                                                                                                 , MEGASIGN_CREATED :
        ///                                                                                                 When a megaSign is
        ...
        public override string ToString()
        {
            ...
            sb.Append("  WebhookConditionalParams: ").Append(WebhookConditionalParams).Append("\n");
