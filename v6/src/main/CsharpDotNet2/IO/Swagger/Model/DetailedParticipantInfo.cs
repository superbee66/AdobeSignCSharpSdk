...
namespace AdobeSignClient.V6.Model
{
    ...
    public class DetailedParticipantInfo
    {
        ...
        /// <summary>
        ///     Fax of the participant. New Agreements can not be created with fax option. This is only returned for legacy
        ///     agreements created with fax as participants
        /// </summary>
        /// <value>
        ///     Fax of the participant. New Agreements can not be created with fax option. This is only returned for legacy
        ///     agreements created with fax as participants
        ...
        /// <summary>
        ///     The unique identifier of the participant. This will be returned as part of Get call but is not mandatory to be
        ///     passed as part of PUT call for agreements/{id}/members/participantSets/{id}.
        /// </summary>
        /// <value>
        ///     The unique identifier of the participant. This will be returned as part of Get call but is not mandatory to be
        ///     passed as part of PUT call for agreements/{id}/members/participantSets/{id}.
        ...
        /// <summary>
        ///     True if this participant is the same user that is calling the API. Returned as part of Get. Ignored (not required)
        ///     if modifying a participant set (PUT).
        /// </summary>
        /// <value>
        ///     True if this participant is the same user that is calling the API. Returned as part of Get. Ignored (not
        ///     required) if modifying a participant set (PUT).
        /// </value>
