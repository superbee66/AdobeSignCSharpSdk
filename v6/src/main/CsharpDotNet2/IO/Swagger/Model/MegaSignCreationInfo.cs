...
namespace AdobeSignClient.V6.Model
{
    ...
    {
        /// <summary>
        ///     A list of one or more CCs that will be copied in the megasign transaction. The CCs will each receive an email at
        ///     the beginning of the transaction and also when the final document is signed. The email addresses will also receive
        ///     a copy of the document, attached as a PDF file
        /// </summary>
        /// <value>
        ///     A list of one or more CCs that will be copied in the megasign transaction. The CCs will each receive an email at
        ///     the beginning of the transaction and also when the final document is signed. The email addresses will also receive
        ...
        /// <summary>
        ///     Date when megasign was created. Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z
        ///     represents UTC time
        /// </summary>
        /// <value>
        ///     Date when megasign was created. Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z
