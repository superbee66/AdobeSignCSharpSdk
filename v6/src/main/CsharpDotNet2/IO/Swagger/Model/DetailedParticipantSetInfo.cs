...
namespace AdobeSignClient.V6.Model
{
    ...
    public class DetailedParticipantSetInfo
    {
        ...
        /// <summary>
        ///     Index indicating sequential signing group (specified for hybrid routing). This cannot be changed as part of the PUT
        ///     call.
        /// </summary>
        /// <value>
        ///     Index indicating sequential signing group (specified for hybrid routing). This cannot be changed as part of the
        ///     PUT call.
        /// </value>
        ...
        /// <summary>
        ///     Participant set's private message - all participants in the set will receive the same message. This cannot be
        ...
        /// <summary>
        ///     Role assumed by all participants in the set (signer, approver etc.). This cannot be changed as part of the PUT
        ///     call.
        /// </summary>
        /// <value>
        ///     Role assumed by all participants in the set (signer, approver etc.). This cannot be changed as part of the PUT
