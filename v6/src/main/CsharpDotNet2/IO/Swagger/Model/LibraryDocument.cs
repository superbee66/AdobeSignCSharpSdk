...
namespace AdobeSignClient.V6.Model
{
    ...
    public class LibraryDocument
    {
        ...
        /// <summary>
        ///     The date on which the library document was last modified. Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g
        ///     2016-02-25T18:46:19Z represents UTC time
        /// </summary>
        /// <value>
        ///     The date on which the library document was last modified. Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example,
        ...
        /// </summary>
        /// <value>
        ///     Specifies who should have access to this library document. GLOBAL sharing mode is not applicable in POST/PUT
        ///     calls
        /// </value>
