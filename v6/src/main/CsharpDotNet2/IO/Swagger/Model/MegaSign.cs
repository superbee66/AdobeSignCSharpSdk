...
namespace AdobeSignClient.V6.Model
{
    ...
    {
        /// <summary>
        ///     The display date for the MegaSign parent agreement. Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g
        ...
        /// <summary>
        ///     True, if the signature type of the MegaSign parent agreement is ESIGN. False, if the signature type of the MegaSign
        ///     parent agreement is WRITTEN
        /// </summary>
        /// <value>
        ///     True, if the signature type of the MegaSign parent agreement is ESIGN. False, if the signature type of the
        ///     MegaSign parent agreement is WRITTEN
        /// </value>
