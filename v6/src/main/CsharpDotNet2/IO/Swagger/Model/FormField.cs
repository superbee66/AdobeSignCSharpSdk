...
namespace AdobeSignClient.V6.Model
{
    ...
    public class FormField
    {
        ...
        /// <summary>
        ///     Further data for validating input with regards to the field's specified format. The contents and interpretation of
        ///     formatData depends on the value of validation.
        /// </summary>
        /// <value>
        ///     Further data for validating input with regards to the field's specified format. The contents and interpretation
        ///     of formatData depends on the value of validation.
        /// </value>
