...
namespace AdobeSignClient.V6.Model
{
    ...
    {
        /// <summary>
        ///     The display date for the agreement. Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z
        ///     represents UTC time
        /// </summary>
        /// <value>
        ///     The display date for the agreement. Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g
        ...
        /// <summary>
        ///     The most relevant current user set for the agreement. It is typically the next signer if the agreement is from the
        ///     current user, or the sender if received from another user
        /// </summary>
        /// <value>
        ///     The most relevant current user set for the agreement. It is typically the next signer if the agreement is from
        ///     the current user, or the sender if received from another user
        /// </value>
        ...
        /// <summary>
        ///     This is a server generated attribute which provides the detailed status of an agreement with respect to the
        ///     apiCaller
        /// </summary>
        /// <value>
        ///     This is a server generated attribute which provides the detailed status of an agreement with respect to the
