...
namespace AdobeSignClient.V6.Model
{
    ...
    public class LibraryDocumentEvent
    {
        ...
        /// <summary>
        ///     The date of the audit event. Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z
        ///     represents UTC time
        /// </summary>
        /// <value>
        ///     The date of the audit event. Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z
        ...
        public LibDocEventDeviceLocation DeviceLocation { get; set; }
        ...
        /// <summary>
        ///     Email address of the user that initiated the event on behalf of the acting user when the account is shared. Will be
        ///     empty if there is no account sharing in effect
        /// </summary>
        /// <value>
        ///     Email address of the user that initiated the event on behalf of the acting user when the account is shared. Will
        ///     be empty if there is no account sharing in effect
        /// </value>
        ...
        /// <summary>
        ///     Full name of the user that initiated the event on behalf of the acting user when the account is shared. Will be
        ///     empty if there is no account sharing in effect
        /// </summary>
        /// <value>
        ///     Full name of the user that initiated the event on behalf of the acting user when the account is shared. Will be
        ...
        /// <summary>
        ///     Email address of the user that is the participant for the event. This may be different than the acting user for
        ///     certain event types. For example, for a DELEGATION event, this is the user who was delegated to
        /// </summary>
        /// <value>
        ///     Email address of the user that is the participant for the event. This may be different than the acting user for
        ///     certain event types. For example, for a DELEGATION event, this is the user who was delegated to
        ...
        /// <summary>
        ///     The unique identifier of the participant for the event. This may be different than the acting user for certain
        ///     event types. For example, for a DELEGATION event, this is the user who was delegated to
        /// </summary>
        /// <value>
        ///     The unique identifier of the participant for the event. This may be different than the acting user for certain
        ///     event types. For example, for a DELEGATION event, this is the user who was delegated to
        ...
        /// </summary>
        /// <value>Type of library document event</value>
