...
namespace AdobeSignClient.V6.Model
{
    ...
    {
        /// <summary>
        ///     A list of one or more CCs that will be copied in the agreement transaction. The CCs will each receive an email at
        ///     the beginning of the transaction and also when the final document is signed. The email addresses will also receive
        ///     a copy of the document, attached as a PDF file. Should not be provided in offline agreement creation.
        /// </summary>
        /// <value>
        ///     A list of one or more CCs that will be copied in the agreement transaction. The CCs will each receive an email
        ///     at the beginning of the transaction and also when the final document is signed. The email addresses will also
        ///     receive a copy of the document, attached as a PDF file. Should not be provided in offline agreement creation.
        /// </value>
        ...
        /// <summary>
        ///     Date when agreement was created. This is a server generated attributed and can not be provided in POST/PUT calls.
        ///     Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z represents UTC time
        /// </summary>
        /// <value>
        ///     Date when agreement was created. This is a server generated attributed and can not be provided in POST/PUT
        ///     calls. Format would be yyyy-MM-dd'T'HH:mm:ssZ. For example, e.g 2016-02-25T18:46:19Z represents UTC time
        /// </value>
        ...
        /// <summary>
        ///     Time after which Agreement expires and needs to be signed before it. Format should be yyyy-MM-dd'T'HH:mm:ssZ. For
        ///     example, e.g 2016-02-25T18:46:19Z represents UTC time. Should not be provided in offline agreement creation.
        /// </summary>
        /// <value>
        ///     Time after which Agreement expires and needs to be signed before it. Format should be yyyy-MM-dd'T'HH:mm:ssZ.
        ///     For example, e.g 2016-02-25T18:46:19Z represents UTC time. Should not be provided in offline agreement creation.
        /// </value>
        ...
        ///         <br>
        ///             If this is not specified but the reminder frequency is specified, then the first reminder will be sent
        ///             based on frequency.
        ///             <br>
        ///                 i.e. if the reminder is created with frequency specified as daily, the firstReminderDelay will be 24
        ///                 hours. Should not be provided in offline agreement creation.
        /// </summary>
        /// <value>
        ///     Integer which specifies the delay in hours before sending the first reminder.
        ///     <br>
        ...
        /// <summary>
        ///     A list of one or more participant set. A participant set may have one or more participant. If any member of the
        ///     participant set takes the action that has been assigned to the set(Sign/Approve/Acknowledge etc ), the action is
        ///     considered as the action taken by whole participation set. For regular (non-MegaSign) documents, there is no limit
        ///     on the number of electronic signatures in a single document. Written signatures are limited to four per document
        /// </summary>
        /// <value>
        ///     A list of one or more participant set. A participant set may have one or more participant. If any member of the
        ///     participant set takes the action that has been assigned to the set(Sign/Approve/Acknowledge etc ), the action is
        ...
        ///     process. Should not be provided in offline agreement creation.
        /// </value>
        ...
        /// <summary>
        ///     Optional parameter that sets how often you want to send reminders to the participants. If it is not specified, the
        ///     default frequency set for the account will be used. Should not be provided in offline agreement creation. If
        ///     provided in PUT as a different value than the current one, an error will be thrown.
        /// </summary>
        /// <value>
        ///     Optional parameter that sets how often you want to send reminders to the participants. If it is not specified,
        ///     the default frequency set for the account will be used. Should not be provided in offline agreement creation. If
        ///     provided in PUT as a different value than the current one, an error will be thrown.
        /// </value>
        ...
        /// <summary>
        ///     Email of agreement sender. Only provided in GET. Can not be provided in POST/PUT request. If provided in POST/PUT,
        ///     it will be ignored
        /// </summary>
        /// <value>
        ///     Email of agreement sender. Only provided in GET. Can not be provided in POST/PUT request. If provided in
        ///     POST/PUT, it will be ignored
        /// </value>
        ...
        /// <summary>
        ///     The state in which the agreement should land. The state field can only be provided in POST calls, will never get
        ///     returned in GET /agreements/{ID} and will be ignored if provided in PUT /agreements/{ID} call. The eventual status
        ///     of the agreement can be obtained from GET /agreements/ID
        /// </summary>
        /// <value>
        ///     The state in which the agreement should land. The state field can only be provided in POST calls, will never get
        ///     returned in GET /agreements/{ID} and will be ignored if provided in PUT /agreements/{ID} call. The eventual status
        ...
        /// <summary>
        ///     The identifier of custom workflow which defines the routing path of an agreement. Should not be provided in offline
        ///     agreement creation.
        /// </summary>
        /// <value>
        ///     The identifier of custom workflow which defines the routing path of an agreement. Should not be provided in
        ///     offline agreement creation.
        /// </value>
