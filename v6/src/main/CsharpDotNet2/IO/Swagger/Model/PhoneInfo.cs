...
namespace AdobeSignClient.V6.Model
{
    ...
    {
        /// <summary>
        ///     The phone Info country code required for the participant to view and sign the document if authentication method is
        ///     PHONE
        /// </summary>
        /// <value>
        ///     The phone Info country code required for the participant to view and sign the document if authentication method
        ///     is PHONE
        /// </value>
