...
namespace AdobeSignClient.V6.Api
{
    ...
    public interface ILibraryDocumentsApi
    {
        ...
        ///     - library document read is always required&lt;/li&gt;&lt;li style&#x3D;&#39;list-style-type: square&#39;&gt;&lt;a
        ...
        ///     When set to YES attach an audit report to the library document PDF. Default value will
        ///     be false.
        /// </param>
        ...
        ///     The version identifier of library_document as provided by the API which retrieves information
        ///     of a specific library document. If not provided then latest version will be used.
        /// </param>
        ...
        /// <summary>
        ///     Retrieves data entered into the interactive form fields of the library document. This API can only be called by the
        ///     creator of the library document
        /// </summary>
        /// <param name="authorization">
        ///     An &lt;a href&#x3D;\&quot;#\&quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot;
        ///     oncontextmenu&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;OAuth Access Token
        ...
        ///     the user that has shared his/her account
        /// </param>
        /// <param name="showHiddenLibraryDocuments">
        ///     A query parameter to fetch all the hidden library documents along with the
        ///     visible library documents. Default value is false.
        /// </param>
        ...
        /// <summary>
        ///     Updates the library document. Currently status, name, sharingMode and templateTypes of the library document can
        ///     only be updated.
        /// </summary>
        /// <param name="authorization">
        ///     An &lt;a href&#x3D;\&quot;#\&quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot;
    ...
    public class LibraryDocumentsApi : ILibraryDocumentsApi
    {
        ...
        public LibraryDocumentViewResponse CreateLibraryDocumentView(string authorization, string libraryDocumentId, LibraryViewInfo libraryViewInfo, string xApiUser, string xOnBehalfOfUser, string ifNoneMatch)
        {
            ...
            string path = "/libraryDocuments/{libraryDocumentId}/views";
            path = path.Replace("{format}", "json");
        ...
        public LibraryDocumentEventList GetEvents(string authorization, string libraryDocumentId, string xApiUser, string xOnBehalfOfUser, string ifNoneMatch)
        {
            ...
            string path = "/libraryDocuments/{libraryDocumentId}/events";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "libraryDocumentId" + "}", ApiClient.ParameterToString(libraryDocumentId));
        ...
        public byte[] GetFormData(string authorization, string libraryDocumentId, string xApiUser, string xOnBehalfOfUser, string ifNoneMatch)
        {
            ...
            string path = "/libraryDocuments/{libraryDocumentId}/formData";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "libraryDocumentId" + "}", ApiClient.ParameterToString(libraryDocumentId));
        ...
        public Note GetLibraryDocumentNoteForApiUser(string authorization, string libraryDocumentId, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/libraryDocuments/{libraryDocumentId}/me/note";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "libraryDocumentId" + "}", ApiClient.ParameterToString(libraryDocumentId));
        ...
        /// </param>
        /// <returns>LibraryDocuments</returns>
        public LibraryDocuments GetLibraryDocuments(string authorization, string xApiUser, string xOnBehalfOfUser, bool? showHiddenLibraryDocuments, string cursor, int? pageSize)
        {
            // verify the required parameter 'authorization' is set
            ...
            return (LibraryDocuments) ApiClient.Deserialize(response.Content, typeof(LibraryDocuments), response.Headers);
        }
        ...
        public void UpdateLibraryDocumentState(string authorization, string ifMatch, string libraryDocumentId, LibraryDocumentStateInfo libraryDocumentStateInfo, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/libraryDocuments/{libraryDocumentId}/state";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "libraryDocumentId" + "}", ApiClient.ParameterToString(libraryDocumentId));
        ...
        public void UpdateLibraryDocumentVisibility(string authorization, string libraryDocumentId, VisibilityInfo visibilityInfo, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/libraryDocuments/{libraryDocumentId}/me/visibility";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "libraryDocumentId" + "}", ApiClient.ParameterToString(libraryDocumentId));
