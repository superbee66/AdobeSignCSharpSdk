...
namespace AdobeSignClient.V6.Api
{
    ...
    public interface ITransientDocumentsApi
    {
        ...
        TransientDocumentResponse CreateTransientDocument(string authorization, Stream file, string xApiUser, string xOnBehalfOfUser, string fileName, string mimeType);
    }
