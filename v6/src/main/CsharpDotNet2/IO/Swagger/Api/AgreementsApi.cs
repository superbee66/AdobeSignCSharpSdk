...
namespace AdobeSignClient.V6.Api
{
    ...
    public interface IAgreementsApi
    {
        ...
        /// <summary>
        ///     Creates an agreement. Sends it out for signatures, and returns the agreementID in the response to the client. This
        ///     is a primary endpoint which is used to create a new agreement. An agreement can be created using transientDocument,
        ///     libraryDocument or a URL. You can create an agreement in one of the 3 mentioned states: a) &lt;b&gt;DRAFT&lt;/b&gt;
        ///     - to incrementally build the agreement before sending out, b) &lt;b&gt;AUTHORING&lt;/b&gt; - to add/edit form
        ///     fields in the agreement, c) &lt;b&gt;IN_PROCESS&lt;/b&gt; - to immediately send the agreement. You can use the PUT
        ///     /agreements/{agreementId}/state endpoint to transition an agreement between the above mentioned states. An allowed
        ///     transition would follow the following sequence: DRAFT -&gt; AUTHORING -&gt; IN_PROCESS -&gt; CANCELLED.
        /// </summary>
        /// <param name="authorization">
        ///     An &lt;a href&#x3D;\&quot;#\&quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot;
        ///     oncontextmenu&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;OAuth Access Token
        ...
        /// <summary>
        ///     Creates a participantSet to which the agreement is forwarded for taking appropriate action. Participants marked as
        ///     delegator can call this API endpoint.
        /// </summary>
        /// <param name="authorization">
        ///     An &lt;a href&#x3D;\&quot;#\&quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot;
        ///     oncontextmenu&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;OAuth Access Token
        ...
        ///     agreement_retention&lt;/a&gt;&lt;/li&gt;&lt;/ul&gt;in the format &lt;b&gt;&#39;Bearer {accessToken}&#39;.
        /// </param>
        /// <param name="ifMatch">
        ///     The server will only update the resource if it matches the listed ETag otherwise error
        ///     RESOURCE_MODIFIED(412) is returned.
        ...
        /// </param>
        /// <param name="status">
        ///     A comma-separated list of reminder statuses of the reminders which should be returned in the
        ///     response. Currently supported values are ACTIVE, CANCELLED, COMPLETE
        /// </param>
        ...
        /// </param>
        /// <param name="showHiddenAgreements">
        ///     A query parameter to fetch all the hidden agreements along with the visible
        ///     agreements. Default value is false.
        /// </param>
        ...
        ///     The participant identifier to be used to retrieve documents. If not mentioned, the
        ///     participation of api caller is used.
        /// </param>
        ...
        ///     get a RESOURCE_NOT_MODIFIED(304) if the resource hasn&#39;t changed.
        /// </param>
        /// <param name="includeNextParticipantSet">
        ///     A query parameter to fetch next active participation members. Default value is
        ///     false.
        /// </param>
        ...
        ///     When set to true, attach an audit report to the signed agreement PDF. Default value is
        ///     false
        /// </param>
        /// <returns>byte[]</returns>
        ...
        /// <summary>
        ///     Retrieves data entered into the interactive form fields of the agreement. This API can only be called by the
        ...
        /// <summary>
        ///     Updates the agreement in draft state, or update the expirationTime on an existing agreement that is already out for
        ///     signature.
        /// </summary>
        /// <param name="authorization">
        ///     An &lt;a href&#x3D;\&quot;#\&quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot;
        ...
        /// <summary>
        ///     Updates an existing reminder for an agreement You can only update an ACTIVE reminder, and can only update the
        ///     status to &#39;CANCELED&#39;, update reminderParticipantIds, or update note.
        /// </summary>
        /// <param name="authorization">
        ///     An &lt;a href&#x3D;\&quot;#\&quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot;
        ///     oncontextmenu&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;OAuth Access Token
        ...
        /// <summary>
        ///     Updates the state of an agreement identified by agreementId in the path. This endpoint can be used by
        ///     originator/sender of an agreement to transition between the states of agreement. An allowed transition would follow
        ///     the following sequence: DRAFT -&gt; AUTHORING -&gt; IN_PROCESS -&gt; CANCELLED.
        /// </summary>
        /// <param name="authorization">
        ///     An &lt;a href&#x3D;\&quot;#\&quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot;
        ///     oncontextmenu&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;OAuth Access Token
    ...
    public class AgreementsApi : IAgreementsApi
    {
        ...
        public AgreementFormFields AddTemplateFieldsToAgreement(string authorization, string ifMatch, string agreementId, FormFieldPostInfo formFieldPostInfo, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/agreements/{agreementId}/formFields";
        ...
        public AgreementViews CreateAgreementView(string authorization, string agreementId, AgreementViewInfo agreementViewInfo, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/agreements/{agreementId}/views";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "agreementId" + "}", ApiClient.ParameterToString(agreementId));
        ...
        public DelegationResponse CreateDelegatedParticipantSets(string authorization, string agreementId, string participantSetId, DelegatedParticipantSetInfo delegatedParticipantSetInfo, string xApiUser)
        {
            ...
            string path = "/agreements/{agreementId}/members/participantSets/{participantSetId}/delegatedParticipantSets";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "agreementId" + "}", ApiClient.ParameterToString(agreementId));
        ...
        public ReminderCreationResult CreateReminderOnParticipant(string authorization, string agreementId, ReminderInfo reminderInfo, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/agreements/{agreementId}/reminders";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "agreementId" + "}", ApiClient.ParameterToString(agreementId));
        ...
        public ShareCreationResponseList CreateShareOnAgreement(string authorization, string agreementId, ShareCreationInfoList shareCreationInfoList, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/agreements/{agreementId}/members/share";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "agreementId" + "}", ApiClient.ParameterToString(agreementId));
        ...
        public Note GetAgreementNoteForApiUser(string authorization, string agreementId, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/agreements/{agreementId}/me/note";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "agreementId" + "}", ApiClient.ParameterToString(agreementId));
        ...
        public ReminderInfo GetAgreementReminder(string authorization, string agreementId, string reminderId, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/agreements/{agreementId}/reminders/{reminderId}";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "agreementId" + "}", ApiClient.ParameterToString(agreementId));
        ...
        public MembersInfo GetAllMembers(string authorization, string agreementId, string xApiUser, string xOnBehalfOfUser, string ifNoneMatch, bool? includeNextParticipantSet)
        {
            ...
            string path = "/agreements/{agreementId}/members";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "agreementId" + "}", ApiClient.ParameterToString(agreementId));
        ...
        public AgreementEventList GetEvents(string authorization, string agreementId, string xApiUser, string xOnBehalfOfUser, string ifNoneMatch)
        {
            ...
            string path = "/agreements/{agreementId}/events";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "agreementId" + "}", ApiClient.ParameterToString(agreementId));
        ...
        public FormFieldMergeInfo GetMergeInfo(string authorization, string agreementId, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/agreements/{agreementId}/formFields/mergeInfo";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "agreementId" + "}", ApiClient.ParameterToString(agreementId));
        ...
        public DetailedParticipantSetInfo GetParticipantSet(string authorization, string agreementId, string participantSetId, string xApiUser, string xOnBehalfOfUser, string ifNoneMatch)
        {
            ...
            string path = "/agreements/{agreementId}/members/participantSets/{participantSetId}";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "agreementId" + "}", ApiClient.ParameterToString(agreementId));
            path = path.Replace("{" + "participantSetId" + "}", ApiClient.ParameterToString(participantSetId));
        ...
        public void RejectAgreementForParticipation(string authorization, string ifMatch, string agreementId, string participantSetId, string participantId, AgreementRejectionInfo agreementRejectionInfo, string xApiUser)
        {
            ...
            string path = "/agreements/{agreementId}/members/participantSets/{participantSetId}/participants/{participantId}/reject";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "agreementId" + "}", ApiClient.ParameterToString(agreementId));
            path = path.Replace("{" + "participantSetId" + "}", ApiClient.ParameterToString(participantSetId));
        ...
        public void UpdateAgreementState(string authorization, string ifMatch, string agreementId, AgreementStateInfo agreementStateInfo, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/agreements/{agreementId}/state";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "agreementId" + "}", ApiClient.ParameterToString(agreementId));
        ...
        public void UpdateAgreementVisibility(string authorization, string agreementId, VisibilityInfo visibilityInfo, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/agreements/{agreementId}/me/visibility";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "agreementId" + "}", ApiClient.ParameterToString(agreementId));
