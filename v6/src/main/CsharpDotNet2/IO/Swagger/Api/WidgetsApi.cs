...
namespace AdobeSignClient.V6.Api
{
    ...
    {
        /// <summary>
        ///     Creates a widget and and returns the widgetId in the response to the client. This is a primary endpoint which is
        ///     used to create a new widget. You can create a widget in one of the 3 mentioned states: a) &lt;b&gt;DRAFT&lt;/b&gt;
        ///     - to incrementally build the widget, b) &lt;b&gt;AUTHORING&lt;/b&gt; - to add/edit form fields in the widget, c)
        ///     &lt;b&gt;ACTIVE&lt;/b&gt; - to immediately host the widget. You can use the PUT /widgets/{widgetId}/state endpoint
        ///     to transition a widget between the above mentioned states. An allowed transition would follow the any of the
        ///     following sequences: DRAFT-&gt;AUTHORING-&gt;ACTIVE, ACTIVE&lt;-&gt;INACTIVE, DRAFT-&gt;CANCELLED.
        /// </summary>
        ...
        ///     oncontextmenu&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;OAuth Access Token
        ///     &lt;/a&gt; with scopes:&lt;ul&gt;&lt;li style&#x3D;&#39;list-style-type: square&#39;&gt;&lt;a href&#x3D;\&quot;#\
        ///     &quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc(&#39;widget_read&#39;)\&quot; oncontextmenu&#x3D;\&quot;
        ///     this.href&#x3D;oauthDoc(&#39;widget_read&#39;)\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;widget_read&lt;/a&gt;
        ///     &lt;/li&gt;&lt;/ul&gt;in the format &lt;b&gt;&#39;Bearer {accessToken}&#39;.
        /// </param>
        /// <param name="widgetId">
        ///     The widget identifier, as returned by the widget creation API or retrieved from the API to fetch
        ///     widgets.
        /// </param>
        /// <param name="xApiUser">
        ///     The userId or email of API caller using the account or group token in the format &lt;b&gt;
        ...
        ///     The version identifier of widget as provided by the API which retrieves information of a
        ///     specific widget. If not provided then latest version will be used.
        /// </param>
        /// <param name="participantId">
        ///     The ID of the participant to be used to retrieve documents. If not mentioned, the
        ///     participation of api caller is used.
        /// </param>
        /// <param name="attachAuditReport">
        ///     When set to YES, attach an audit report to the signed Widget PDF. Default value is
        ///     false
        /// </param>
        /// <returns>byte[]</returns>
        ...
        /// <summary>
        ///     Retrieves data entered by the user into interactive form fields at the time they signed the widget CSV file stream
        ///     containing form data information
        /// </summary>
        /// <param name="authorization">
        ///     An &lt;a href&#x3D;\&quot;#\&quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot;
        ///     oncontextmenu&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;OAuth Access Token
        ...
        ///     the user that has shared his/her account
        /// </param>
        /// <param name="showHiddenWidgets">
        ///     A query parameter to fetch all the hidden widgets along with the visible widgets.
        ...
        ///     &quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc(&#39;widget_read&#39;)\&quot; oncontextmenu&#x3D;\&quot;
        ///     this.href&#x3D;oauthDoc(&#39;widget_read&#39;)\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;widget_read&lt;/a&gt; -
        ///     widget read is always required&lt;/li&gt;&lt;li style&#x3D;&#39;list-style-type: square&#39;&gt;&lt;a href&#x3D;\
        ///     &quot;#\&quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc(&#39;user_login&#39;)\&quot; oncontextmenu&#x3D;\&quot;
        ///     this.href&#x3D;oauthDoc(&#39;user_login&#39;)\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;user_login&lt;/a&gt; -
        ///     Required additionally if the autoLoginUser parameter is set to true&lt;/li&gt;&lt;/ul&gt;in the format &lt;b&gt;
        ///     &#39;Bearer {accessToken}&#39;.
        /// </param>
        /// <param name="widgetId">
        ///     The widget identifier, as returned by the widget creation API or retrieved from the API to fetch
        ...
        /// <summary>
        ///     Updates the state of a widget identified by widgetId in the path. This endpoint can be used by creator of the
        ///     widget to transition between the states of widget. An allowed transition would follow any of the following sequence
        ///     :  DRAFT-&gt;AUTHORING-&gt;ACTIVE, ACTIVE&lt;-&gt;INACTIVE, DRAFT-&gt;CANCELLED.
        /// </summary>
        /// <param name="authorization">
        ///     An &lt;a href&#x3D;\&quot;#\&quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot;
        ///     oncontextmenu&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;OAuth Access Token
    ...
    public class WidgetsApi : IWidgetsApi
    {
        ...
        public WidgetMembersInfo GetAllWidgetMembers(string authorization, string widgetId, string xApiUser, string xOnBehalfOfUser, string ifNoneMatch)
        {
            ...
            string path = "/widgets/{widgetId}/members";
            path = path.Replace("{format}", "json");
        ...
        public WidgetEventList GetEvents(string authorization, string widgetId, string xApiUser, string xOnBehalfOfUser, string ifNoneMatch)
        {
            ...
            string path = "/widgets/{widgetId}/events";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "widgetId" + "}", ApiClient.ParameterToString(widgetId));
        ...
        public DetailedWidgetParticipantSetInfo GetParticipantSet(string authorization, string widgetId, string participantSetId, string xApiUser, string xOnBehalfOfUser, string ifNoneMatch)
        {
            ...
            string path = "/widgets/{widgetId}/members/participantSets/{participantSetId}";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "widgetId" + "}", ApiClient.ParameterToString(widgetId));
        ...
        public WidgetAgreements GetWidgetAgreements(string authorization, string widgetId, string xApiUser, string xOnBehalfOfUser, bool? showHiddenAgreements, string cursor, int? pageSize)
        {
            ...
            string path = "/widgets/{widgetId}/agreements";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "widgetId" + "}", ApiClient.ParameterToString(widgetId));
        ...
        public byte[] GetWidgetAuditTrail(string authorization, string widgetId, string xApiUser, string xOnBehalfOfUser, string ifNoneMatch)
        {
            ...
            string path = "/widgets/{widgetId}/auditTrail";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "widgetId" + "}", ApiClient.ParameterToString(widgetId));
        ...
        public byte[] GetWidgetCombinedDocument(string authorization, string widgetId, string xApiUser, string xOnBehalfOfUser, string ifNoneMatch, string versionId, string participantId, bool? attachAuditReport)
        {
            ...
            string path = "/widgets/{widgetId}/combinedDocument";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "widgetId" + "}", ApiClient.ParameterToString(widgetId));
        ...
        public byte[] GetWidgetDocumentInfo(string authorization, string widgetId, string documentId, string xApiUser, string xOnBehalfOfUser, string ifNoneMatch)
        {
            ...
            string path = "/widgets/{widgetId}/documents/{documentId}";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "widgetId" + "}", ApiClient.ParameterToString(widgetId));
        ...
        public WidgetDocuments GetWidgetDocuments(string authorization, string widgetId, string xApiUser, string xOnBehalfOfUser, string ifNoneMatch, string versionId, string participantId)
        {
            ...
            string path = "/widgets/{widgetId}/documents";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "widgetId" + "}", ApiClient.ParameterToString(widgetId));
        ...
        public byte[] GetWidgetFormData(string authorization, string widgetId, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/widgets/{widgetId}/formData";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "widgetId" + "}", ApiClient.ParameterToString(widgetId));
        ...
        public Note GetWidgetNoteForApiUser(string authorization, string widgetId, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/widgets/{widgetId}/me/note";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "widgetId" + "}", ApiClient.ParameterToString(widgetId));
        ...
        public WidgetViews GetWidgetView(string authorization, string widgetId, WidgetViewInfo widgetViewInfo, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/widgets/{widgetId}/views";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "widgetId" + "}", ApiClient.ParameterToString(widgetId));
        ...
        public void UpdateWidgetState(string authorization, string ifMatch, string widgetId, WidgetStateInfo widgetStateInfo, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/widgets/{widgetId}/state";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "widgetId" + "}", ApiClient.ParameterToString(widgetId));
        ...
        public void UpdateWidgetVisibility(string authorization, string widgetId, VisibilityInfo visibilityInfo, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/widgets/{widgetId}/me/visibility";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "widgetId" + "}", ApiClient.ParameterToString(widgetId));
