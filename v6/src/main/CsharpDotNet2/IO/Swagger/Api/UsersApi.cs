...
namespace AdobeSignClient.V6.Api
{
    ...
    public interface IUsersApi
    {
        ...
        ///     /ul&gt;in the format &lt;b&gt;&#39;Bearer {accessToken}&#39;.
        /// </param>
        /// <param name="userId">
        ...
        ///     &lt;/a&gt; with scopes:&lt;ul&gt;&lt;li style&#x3D;&#39;list-style-type: square&#39;&gt;&lt;a href&#x3D;\&quot;#\
        ///     &quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc(&#39;user_read&#39;)\&quot; oncontextmenu&#x3D;\&quot;this.href
        ///     &#x3D;oauthDoc(&#39;user_read&#39;)\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;user_read&lt;/a&gt; - user read is
        ///     always required&lt;/li&gt;&lt;li style&#x3D;&#39;list-style-type: square&#39;&gt;&lt;a href&#x3D;\&quot;#\&quot;
        ///     onclick&#x3D;\&quot;this.href&#x3D;oauthDoc(&#39;user_login&#39;)\&quot; oncontextmenu&#x3D;\&quot;this.href&#x3D;
        ///     oauthDoc(&#39;user_login&#39;)\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;user_login&lt;/a&gt; - Required
        ///     additionally if the autoLoginUser parameter is set to true&lt;/li&gt;&lt;/ul&gt;in the format &lt;b&gt;&#39;Bearer
        ///     {accessToken}&#39;.
        /// </param>
        /// <param name="userId">
        ///     The user identifier, as returned by the user creation API or retrieved from the API to fetch
        ...
        /// <param name="userId">
        ///     The user identifier, as returned by the user creation API or retrieved from the API to fetch
        ///     users. To update the details for the token owner, UserId can be replaced by \&quot;me\&quot; without quotes.
        /// </param>
    ...
    public class UsersApi : IUsersApi
    {
        ...
        public UserStatusUpdateResponse ModifyUserState(string authorization, string userId, UserStateInfo userStateInfo, string xApiUser)
        {
            ...
            string path = "/users/{userId}/state";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "userId" + "}", ApiClient.ParameterToString(userId));
