...
namespace AdobeSignClient.V6.Api
{
    ...
    public interface IWebhooksApi
    {
        ...
        ///     oncontextmenu&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;OAuth Access Token
        ///     &lt;/a&gt; with scopes:&lt;ul&gt;&lt;li style&#x3D;&#39;list-style-type: square&#39;&gt;&lt;a href&#x3D;\&quot;#\
        ///     &quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc(&#39;webhook_retention&#39;)\&quot; oncontextmenu&#x3D;\&quot;
        ///     this.href&#x3D;oauthDoc(&#39;webhook_retention&#39;)\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;webhook_retention
        ...
        ///     The webhook identifier, as returned by the webhook creation API or retrieved from the API to
        ///     fetch webhooks.
        /// </param>
        /// <param name="xApiUser">
        ///     The userId or email of API caller using the account or group token in the format &lt;b&gt;
        ...
        ///     oncontextmenu&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;OAuth Access Token
        ///     &lt;/a&gt; with scopes:&lt;ul&gt;&lt;li style&#x3D;&#39;list-style-type: square&#39;&gt;&lt;a href&#x3D;\&quot;#\
        ///     &quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc(&#39;webhook_read&#39;)\&quot; oncontextmenu&#x3D;\&quot;
        ///     this.href&#x3D;oauthDoc(&#39;webhook_read&#39;)\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;webhook_read&lt;/a&gt;
        ///     &lt;/li&gt;&lt;/ul&gt;in the format &lt;b&gt;&#39;Bearer {accessToken}&#39;.
        /// </param>
        /// <param name="webhookId">
        ///     The webhook identifier, as returned by the webhook creation API or retrieved from the API to
        ...
        ///     The type of resource on which webhook was created. The possible values are AGREEMENT,
        ///     WIDGET, MEGASIGN and LIBRARY_DOCUMENT.
        /// </param>
    ...
    public class WebhooksApi : IWebhooksApi
    {
        ...
        public void DeleteWebhook(string authorization, string ifMatch, string webhookId, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/webhooks/{webhookId}";
            path = path.Replace("{format}", "json");
        ...
        public void UpdateWebhookState(string authorization, string ifMatch, string webhookId, WebhookStateInfo webhookStateInfo, string xApiUser, string xOnBehalfOfUser)
        {
            ...
            string path = "/webhooks/{webhookId}/state";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "webhookId" + "}", ApiClient.ParameterToString(webhookId));
