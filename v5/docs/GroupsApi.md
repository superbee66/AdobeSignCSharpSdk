...
namespace Example
{
    public class CreateGroupExample
    {
        public void main()
        {
            ...
            {
                // Creates a new group in an account.
                GroupCreationResponse result = apiInstance.CreateGroup(accessToken, groupCreationInfo, xApiUser);
...
namespace Example
{
    public class DeleteGroupExample
    {
        public void main()
        {
            ...
            {
                // Delete an existing group.
                apiInstance.DeleteGroup(accessToken, groupId, xApiUser);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class GetGroupDetailsExample
    {
        public void main()
        {
            ...
            {
                // Retrieves detailed information about the group.
                GroupDetailsInfo result = apiInstance.GetGroupDetails(accessToken, groupId, xApiUser);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class GetGroupsExample
    {
        public void main()
        {
            ...
            {
                // Retrieves all the groups in an account.
                GroupsInfo result = apiInstance.GetGroups(accessToken, xApiUser);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class GetUsersInGroupExample
    {
        public void main()
        {
            ...
            {
                // Retrieves all the users in a group.
                UsersInfo result = apiInstance.GetUsersInGroup(accessToken, groupId, xApiUser);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class ModifyGroupExample
    {
        public void main()
        {
            ...
            {
                // Update an existing group.
                GroupModificationResponse result = apiInstance.ModifyGroup(accessToken, groupId, groupModificationInfo, xApiUser);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
