...
namespace Example
{
    public class CreateWorkflowAgreementExample
    {
        public void main()
        {
            ...
            {
                // Creates an agreement. Sends it out for signatures, and returns the agreementId in the response to the client.
                AgreementCreationResponse result = apiInstance.CreateWorkflowAgreement(accessToken, workflowId, customWorkflowAgreementCreationRequest, xApiUser);
...
namespace Example
{
    public class GetWorkflowInfoExample
    {
        public void main()
        {
            ...
            {
                // Retrieves the details of a workflow.
                WorkflowDescription result = apiInstance.GetWorkflowInfo(accessToken, workflowId, xApiUser);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class GetWorkflowsExample
    {
        public void main()
        {
            ...
            {
                // Retrieves workflows for a user.
                UserWorkflows result = apiInstance.GetWorkflows(accessToken, xApiUser, includeDraftWorkflows, groupId);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
