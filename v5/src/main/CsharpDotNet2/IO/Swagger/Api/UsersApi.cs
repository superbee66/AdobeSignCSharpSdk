...
namespace IO.Swagger.Api
{
    ...
    public interface IUsersApi
    {
        ...
        /// <summary>
        /// Retrieve detailed information about the user in the caller account. If caller is neither an account admin nor group admin then some user information won&#39;t be returned.
        /// </summary>
