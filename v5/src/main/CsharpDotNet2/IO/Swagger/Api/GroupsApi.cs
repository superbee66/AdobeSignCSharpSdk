...
namespace AdobeSignClient.V5.Api
{
    ...
    public interface IGroupsApi
    {
        ...
        GroupCreationResponse CreateGroup(string accessToken, GroupCreationInfo groupCreationInfo, string xApiUser);
        ...
        /// </param>
        /// <param name="groupId">
        ///     The group identifier, as returned by the group creation API or retrieved from the API to fetch
        ///     groups
        /// </param>
        /// <param name="xApiUser">
        ///     The userId or email of API caller using the account or group token in the format &lt;b&gt;
        ...
        /// </param>
        /// <returns></returns>
        void DeleteGroup(string accessToken, string groupId, string xApiUser);
        ...
        GroupDetailsInfo GetGroupDetails(string accessToken, string groupId, string xApiUser);
        ...
        GroupsInfo GetGroups(string accessToken, string xApiUser);
        ...
        UsersInfo GetUsersInGroup(string accessToken, string groupId, string xApiUser);
        ...
        GroupModificationResponse ModifyGroup(string accessToken, string groupId, GroupModificationInfo groupModificationInfo, string xApiUser);
    }
    ...
    public class GroupsApi : IGroupsApi
    {
        ...
        /// </param>
        /// <returns>GroupCreationResponse</returns>
        public GroupCreationResponse CreateGroup(string accessToken, GroupCreationInfo groupCreationInfo, string xApiUser)
        {
        ...
        /// </param>
        /// <returns></returns>
        public void DeleteGroup(string accessToken, string groupId, string xApiUser)
        {
            // verify the required parameter 'accessToken' is set
        ...
        /// </param>
        /// <returns>GroupDetailsInfo</returns>
        public GroupDetailsInfo GetGroupDetails(string accessToken, string groupId, string xApiUser)
        {
            // verify the required parameter 'accessToken' is set
        ...
        /// </param>
        /// <returns>GroupsInfo</returns>
        public GroupsInfo GetGroups(string accessToken, string xApiUser)
        {
            // verify the required parameter 'accessToken' is set
        ...
        /// </param>
        /// <returns>UsersInfo</returns>
        public UsersInfo GetUsersInGroup(string accessToken, string groupId, string xApiUser)
        {
            // verify the required parameter 'accessToken' is set
            ...
            string path = "/groups/{groupId}/users";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "groupId" + "}", ApiClient.ParameterToString(groupId));
        ...
        /// </param>
        /// <returns>GroupModificationResponse</returns>
        public GroupModificationResponse ModifyGroup(string accessToken, string groupId, GroupModificationInfo groupModificationInfo, string xApiUser)
        {
            // verify the required parameter 'accessToken' is set
