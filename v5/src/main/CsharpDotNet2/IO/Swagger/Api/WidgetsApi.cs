...
namespace AdobeSignClient.V5.Api
{
    ...
    public interface IWidgetsApi
    {
        ...
        /// <summary>
        ///     Gets a single combined PDF document for the documents associated with a widget. A File Stream of combined PDF
        ///     document
        /// </summary>
        /// <param name="accessToken">
        ///     An &lt;a href&#x3D;\&quot;#\&quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc()\&quot;
    ...
    public class WidgetsApi : IWidgetsApi
    {
        ...
        /// </param>
        /// <returns>WidgetCreationResponse</returns>
        public WidgetCreationResponse CreateWidget(string accessToken, WidgetCreationRequest widgetCreationRequest, string xApiUser)
        {
        ...
        /// </param>
        /// <returns>WidgetAgreements</returns>
        public WidgetAgreements GetWidgetAgreements(string accessToken, string widgetId, string xApiUser)
        {
            // verify the required parameter 'accessToken' is set
        ...
        /// </param>
        /// <returns>byte[]</returns>
        public byte[] GetWidgetAuditTrail(string accessToken, string widgetId, string xApiUser)
        {
            // verify the required parameter 'accessToken' is set
        ...
        /// <param name="auditReport">When set to YES, attach an audit report to the signed Widget PDF. Default value is false</param>
        /// <returns>byte[]</returns>
        public byte[] GetWidgetCombinedDocument(string accessToken, string widgetId, string xApiUser, string versionId, string participantEmail, bool? auditReport)
        {
            // verify the required parameter 'accessToken' is set
        ...
        /// </param>
        /// <returns>byte[]</returns>
        public byte[] GetWidgetDocumentInfo(string accessToken, string widgetId, string documentId, string xApiUser)
        {
            // verify the required parameter 'accessToken' is set
        ...
        /// <param name="participantEmail">The email address of the participant to be used to retrieve documents.</param>
        /// <returns>WidgetDocuments</returns>
        public WidgetDocuments GetWidgetDocuments(string accessToken, string widgetId, string xApiUser, string versionId, string participantEmail)
        {
            // verify the required parameter 'accessToken' is set
        ...
        /// </param>
        /// <returns>byte[]</returns>
        public byte[] GetWidgetFormData(string accessToken, string widgetId, string xApiUser)
        {
            // verify the required parameter 'accessToken' is set
        ...
        /// </param>
        /// <returns>WidgetInfo</returns>
        public WidgetInfo GetWidgetInfo(string accessToken, string widgetId, string xApiUser)
        {
            // verify the required parameter 'accessToken' is set
        ...
        /// </param>
        /// <returns>UserWidgets</returns>
        public UserWidgets GetWidgets(string accessToken, string xApiUser)
        {
            // verify the required parameter 'accessToken' is set
        ...
        /// </param>
        /// <returns>WidgetPersonalizeResponse</returns>
        public WidgetPersonalizeResponse UpdateWidgetPersonalize(string accessToken, string widgetId, WidgetPersonalizationInfo widgetPersonalizationInfo, string xApiUser)
        {
            // verify the required parameter 'accessToken' is set
            ...
            string path = "/widgets/{widgetId}/personalize";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "widgetId" + "}", ApiClient.ParameterToString(widgetId));
        ...
        /// </param>
        /// <returns>WidgetStatusUpdateResponse</returns>
        public WidgetStatusUpdateResponse UpdateWidgetStatus(string accessToken, string widgetId, WidgetStatusUpdateInfo widgetStatusUpdateInfo, string xApiUser)
        {
            // verify the required parameter 'accessToken' is set
            ...
            string path = "/widgets/{widgetId}/status";
            path = path.Replace("{format}", "json");
            path = path.Replace("{" + "widgetId" + "}", ApiClient.ParameterToString(widgetId));
