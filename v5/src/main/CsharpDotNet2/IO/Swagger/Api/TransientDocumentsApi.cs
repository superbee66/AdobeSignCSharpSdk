...
namespace AdobeSignClient.V5.Api
{
    ...
    public interface ITransientDocumentsApi
    {
        ...
        TransientDocumentResponse CreateTransientDocument(string accessToken, Stream file, string xApiUser, string fileName, string mimeType);
    }
    ...
    public class TransientDocumentsApi : ITransientDocumentsApi
    {
        ...
        /// </param>
        /// <returns>TransientDocumentResponse</returns>
        public TransientDocumentResponse CreateTransientDocument(string accessToken, Stream file, string xApiUser, string fileName, string mimeType)
        {
