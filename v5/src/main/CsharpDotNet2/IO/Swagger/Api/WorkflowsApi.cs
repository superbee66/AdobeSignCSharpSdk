...
namespace AdobeSignClient.V5.Api
{
    ...
    public interface IWorkflowsApi
    {
        ...
        ///     &quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc(&#39;workflow_read&#39;)\&quot; oncontextmenu&#x3D;\&quot;
        ///     this.href&#x3D;oauthDoc(&#39;workflow_read&#39;)\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;workflow_read&lt;/a
        ///     &gt; - To read the workflow resource which will be used for agreement creation&lt;/li&gt;&lt;li style&#x3D;&#39;
        ///     list-style-type: square&#39;&gt;&lt;a href&#x3D;\&quot;#\&quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc(&#39;
        ///     agreement_send&#39;)\&quot; oncontextmenu&#x3D;\&quot;this.href&#x3D;oauthDoc(&#39;agreement_send&#39;)\&quot;
        ///     target&#x3D;\&quot;oauthDoc\&quot;&gt;agreement_send&lt;/a&gt; - If authoringRequested parameter is set to false
        ///     &lt;/li&gt;&lt;li style&#x3D;&#39;list-style-type: square&#39;&gt;&lt;a href&#x3D;\&quot;#\&quot; onclick&#x3D;\
        ///     &quot;this.href&#x3D;oauthDoc(&#39;agreement_write&#39;)\&quot; oncontextmenu&#x3D;\&quot;this.href&#x3D;oauthDoc(
        ///     &#39;agreement_write&#39;)\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;agreement_write&lt;/a&gt; - If
        ///     authoringRequested parameter is set to true&lt;/li&gt;&lt;li style&#x3D;&#39;list-style-type: square&#39;&gt;&lt;a
        ///     href&#x3D;\&quot;#\&quot; onclick&#x3D;\&quot;this.href&#x3D;oauthDoc(&#39;user_login&#39;)\&quot; oncontextmenu
        ///     &#x3D;\&quot;this.href&#x3D;oauthDoc(&#39;user_login&#39;)\&quot; target&#x3D;\&quot;oauthDoc\&quot;&gt;user_login
        ///     &lt;/a&gt; - Required additionally if the autoLoginUser parameter is set to true&lt;/li&gt;&lt;/ul&gt;
        /// </param>
        /// <param name="workflowId">The workflow identifier, as retrieved from the API to fetch workflows.</param>
        /// <param name="customWorkflowAgreementCreationRequest">
        ///     Information about the agreement that you want to send and
        ///     authoring options that you want to apply at the time of sending. NOTE: optional specified with the input parameters
        ///     is a general guideline on normal request sent to this endpoint. You need to check the actual workflow definition to
        ...
        AgreementCreationResponse CreateWorkflowAgreement(string accessToken, string workflowId, CustomWorkflowAgreementCreationRequest customWorkflowAgreementCreationRequest, string xApiUser);
        ...
        WorkflowDescription GetWorkflowInfo(string accessToken, string workflowId, string xApiUser);
        ...
        UserWorkflows GetWorkflows(string accessToken, string xApiUser, bool? includeDraftWorkflows, string groupId);
    }
    ...
    public class WorkflowsApi : IWorkflowsApi
    {
        ...
        /// </param>
        /// <returns>AgreementCreationResponse</returns>
        public AgreementCreationResponse CreateWorkflowAgreement(string accessToken, string workflowId, CustomWorkflowAgreementCreationRequest customWorkflowAgreementCreationRequest, string xApiUser)
        {
            ...
            string path = "/workflows/{workflowId}/agreements";
        ...
        /// </param>
        /// <returns>WorkflowDescription</returns>
        public WorkflowDescription GetWorkflowInfo(string accessToken, string workflowId, string xApiUser)
        {
            // verify the required parameter 'accessToken' is set
        ...
        /// <param name="groupId">The group identifier for which the workflows will be fetched</param>
        /// <returns>UserWorkflows</returns>
        public UserWorkflows GetWorkflows(string accessToken, string xApiUser, bool? includeDraftWorkflows, string groupId)
        {
            // verify the required parameter 'accessToken' is set
