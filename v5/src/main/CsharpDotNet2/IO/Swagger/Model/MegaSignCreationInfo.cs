...
namespace AdobeSignClient.V5.Model
{
    ...
    public class MegaSignCreationInfo
    {
        ...
        /// <summary>
        ///     The merge file ID as returned from the transient document creation API. The merge file contains the details of all
        ///     the Mega Sign recipients.
        /// </summary>
        /// <value>
        ///     The merge file ID as returned from the transient document creation API. The merge file contains the details of
        ///     all the Mega Sign recipients.
        /// </value>
