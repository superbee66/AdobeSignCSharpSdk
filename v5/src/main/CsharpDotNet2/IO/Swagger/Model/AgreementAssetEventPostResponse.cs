...
namespace IO.Swagger.Model {
  ...
  public class AgreementAssetEventPostResponse {
    /// <summary>
    /// The search Id corresponding to current search object. This searchId can be used in combination with pageCursors retrieved from the API which retrieves agreementAssetEvents based on a searchId, to fetch the result for further pages
    /// </summary>
    /// <value>The search Id corresponding to current search object. This searchId can be used in combination with pageCursors retrieved from the API which retrieves agreementAssetEvents based on a searchId, to fetch the result for further pages</value>
    ...
    /// </summary>
    /// <value>The page cursor of the next page to be fetched. If the next page cursor is blank then the given page is the last page</value>
