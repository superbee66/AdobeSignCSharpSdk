...
namespace AdobeSignClient.V5.Model {
  ...
  public class ParticipantSetInfo {
    ...
    /// </summary>
    /// <value>The unique identifier of the participant set</value>
    [DataMember(Name="participantSetId", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "participantSetId")]
    ...
    public override string ToString()  {
      ...
      sb.Append("  ParticipantSetId: ").Append(ParticipantSetId).Append("\n");
