...
namespace AdobeSignClient.V5.Model {
  ...
  public class WidgetCreationInfo {
    ...
    /// </summary>
    /// <value>Selects the workflow you would like to use - whether the sender needs to sign before the recipient, after the recipient, or not at all. The possible values for this variable are SENDER_SIGNATURE_NOT_REQUIRED or SENDER_SIGNS_LAST</value>
