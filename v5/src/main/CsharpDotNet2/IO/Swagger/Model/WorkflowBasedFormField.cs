...
namespace AdobeSignClient.V5.Model {
  ...
  public class WorkflowBasedFormField {
    ...
    [DataMember(Name="recipientListName", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "recipientListName")]
    ...
    /// </summary>
    /// <value>Conditions to be evaluated which decides the visibility of the form field in association with showOrHide property</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class WorkflowBasedFormField {\n");
      ...
      sb.Append("  RecipientListName: ").Append(RecipientListName).Append("\n");
