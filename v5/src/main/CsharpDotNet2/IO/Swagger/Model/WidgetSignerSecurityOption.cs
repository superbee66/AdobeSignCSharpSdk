...
namespace AdobeSignClient.V5.Model
{
    ...
    {
        /// <summary>
        ///     The authentication method for the recipients to have access to view and sign the widget. PHONE authentication is
        ///     only applicable to counter signers but not to widget signer
        /// </summary>
        /// <value>
        ///     The authentication method for the recipients to have access to view and sign the widget. PHONE authentication is
        ///     only applicable to counter signers but not to widget signer
        ...
        /// <summary>
        ///     The phoneInfo required for the counter signer to view and sign the widget if authentication method is PHONE. Not
        ///     applicable to widget signer
        /// </summary>
        /// <value>
        ///     The phoneInfo required for the counter signer to view and sign the widget if authentication method is PHONE. Not
        ///     applicable to widget signer
