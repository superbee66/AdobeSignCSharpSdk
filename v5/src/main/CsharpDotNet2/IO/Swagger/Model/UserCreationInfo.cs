...
namespace AdobeSignClient.V5.Model
{
    ...
    public class UserCreationInfo
    {
        ...
        /// <summary>
        ///     Group in which the new user should be added. It can be obtained through a call to the API which retrieves users.
        ///     Default is Group of the user making this call. The user is inferred from the access_token header.
        /// </summary>
        /// <value>
        ///     Group in which the new user should be added. It can be obtained through a call to the API which retrieves users.
        ///     Default is Group of the user making this call. The user is inferred from the access_token header.
        ...
        /// <summary>
        ///     Whether or not the user has opted in to receive marketing information from Adobe Sign and its partners. Default
        ///     value is UNKNOWN
        /// </summary>
        /// <value>
        ///     Whether or not the user has opted in to receive marketing information from Adobe Sign and its partners. Default
