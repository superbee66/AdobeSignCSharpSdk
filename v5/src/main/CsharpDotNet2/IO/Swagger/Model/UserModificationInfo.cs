...
namespace AdobeSignClient.V5.Model
{
    ...
    public class UserModificationInfo
    {
        ...
        /// <summary>
        ///     The new group in which the user should be added. It can be obtained through <b>GET /users</b> call. The server will
        ///     reset to default if the value is not provided
        /// </summary>
        /// <value>
        ///     The new group in which the user should be added. It can be obtained through <b>GET /users</b> call. The server
        ///     will reset to default if the value is not provided
        /// </value>
        ...
        /// <summary>
        ///     Whether or not the user has opted in to receive the marketing information from Adobe Sign and its partners. The
        ///     server will reset to null if the value is not provided.
        /// </summary>
        /// <value>
        ///     Whether or not the user has opted in to receive the marketing information from Adobe Sign and its partners. The
        ///     server will reset to null if the value is not provided.
