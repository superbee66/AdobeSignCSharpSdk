...
namespace IO.Swagger.Model {
  ...
  public class URLFileInfo {
    ...
    /// </summary>
    /// <value>The original system file name of the document being sent - used to name attachments, and to infer the mime type if one is not explicitly specified</value>
    ...
    /// </summary>
    /// <value>A publicly accessible URL for retrieving the raw file content. HTTP authentication is supported using standard embedded syntax - i.e. http://username:password@your.server.com/path/to/file.</value>
