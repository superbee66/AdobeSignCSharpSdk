...
namespace AdobeSignClient.V1.Model
{
    ...
    public class SecurityOption
    {
        ...
        /// <summary>
        ///     The secondary password that is used to secure the document. Note that Adobe Sign never displays this password. You
        ///     need to communicate this password to the appropriate users. Note: This field is required if either sign or open
        ///     password option was set
        /// </summary>
        /// <value>
        ///     The secondary password that is used to secure the document. Note that Adobe Sign never displays this password.
        ///     You need to communicate this password to the appropriate users. Note: This field is required if either sign or open
        ///     password option was set
        /// </value>
